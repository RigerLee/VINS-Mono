...
{
public:
	KeyFrame(double _time_stamp, int _index, Vector3d &_vio_T_w_i, Matrix3d &_vio_R_w_i, cv::Mat &_image, vector<std::pair<cv::Point3f, cv::Vec3b>> &_point_3d_depth,
